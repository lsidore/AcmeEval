		...
		<div className="container px-4 md:px-6">
			<div className="grid max-w-3xl mx-auto gap-8 text-center">
				...
				<p className="text-gray-200 md:text-xl">
					Streamline your RAG testing process with our open-source
					TypeScript library. Ensure your models are performing as
					expected across a wide range of scenarios.
				</p>
